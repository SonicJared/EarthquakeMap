 ...
 * @usage
 * ```js
 * var EarthquakeMap = angular.module('reallyCoolApp', ['ionic']);
 *
 * EarthquakeMap.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('EarthquakeMap', ['ionic'])
 ...
 *
 * ```js
 *   angular.module('EarthquakeMap', ['ionic'])
 ...
 *
 * ```
 * angular.module('EarthquakeMap', ['ngRoute'])`
 * ```
 *
 * becomes
 *
 * ```
 * angular.module('EarthquakeMap', ['ngRoute', 'ngIOS9UIWebViewPatch'])
 * ```
 *
 *
 * More info:
